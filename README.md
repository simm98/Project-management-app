...
http://localhost:8000/ → JSON de bienvenida.
...
11. Update documents available for user by id : curl -X PUT "http://127.0.0.1:8000/document/1" -H "Authorization: Bearer TOKEN" -F "file=@I:/Prueba1_update.odt"
